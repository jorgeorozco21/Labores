<div class="flex flex-col md:flex-row items-end gap-4 mb-6 bg-white p-6 rounded-[20px] border border-gray-100 shadow-sm">
    ...
    <div class="flex-1 w-full">
        <label for="buscador" class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-2 ml-1">Buscar Usuarios</label>
        <div class="relative">
            ...
            <input type="text" id="buscador" placeholder="Nombre Usuario o Nombre" autocomplete="off"
