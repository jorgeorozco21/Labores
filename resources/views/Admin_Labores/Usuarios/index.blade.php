        ...
        <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
            <header class="bg-white border-b border-gray-100 px-4 md:px-8 py-4 flex justify-between items-center shrink-0">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-lg md:text-xl font-extrabold text-gray-800 leading-tight">Usuarios</h2>
                    </div>
                </div>
            ...
            <div class="p-6 space-y-6">
                <x-admin-labores.filtro-usuarios />
                <x-admin-labores.tabla-usuarios :usuarios="$usuarios" />
            </div>
        </main>
    </div>

    <x-admin.modal-editar titulo="Editar Usuario">
        @include('Admin_Labores.Usuarios.form_editar')
    </x-admin.modal-editar>

    <x-admin-labores.modal-nuevo titulo="Nuevo Usuario" action="{{ route('labores.usuarios.storeAdmin') }}" >
        @include('Admin_Labores.Usuarios.form')
    </x-admin-labores.modal-nuevo>

    @vite(['resources/js/Admin_Labores/crud_usuarios.js','resources/js/Admin/alertas.js', 'resources/js/Admin_Labores/modales.js', 'resources/js/Admin_Labores/buscador_usuarios.js'])
</body>
</html>